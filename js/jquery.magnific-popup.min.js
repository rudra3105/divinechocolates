! function(e) {
    ...
    y.prototype = {
        ...
        open: function(n) {
            ...
            }), a += " mfp-close-btn-in") : t.wrap.append(T())), t.st.alignTop && (a += " mfp-align-top"), t.wrap.css(t.fixedContentPos ? {
            ...
            t.fixedContentPos && (t.isIE7 ? e("body, html").css("overflow", "hidden") : f.overflow = "hidden"), t.st.blackbg ? t.bgOverlay.addClass("mfp-black-bg") : "", t.st.whitebg ? t.bgOverlay.addClass("mfp-white-bg") : "";
        ...
        updateItemHTML: function() {
            ...
            if (k("BeforeChange", [t.currItem ? t.currItem.type : "", i]), t.currItem = n, !t.currTemplate[i]) {
                ...
                k("FirstMarkupParse", a), t.currTemplate[i] = a ? e(a) : !0
            }
            o && o !== n.type && t.container.removeClass("mfp-" + o + "-holder");
            var r = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
            t.appendContent(r, i), n.preloaded = !0, k(f, n), o = n.type, t.container.prepend(t.contentContainer), k("AfterChange")
        },
            ...
            getInline: function(n, i) {
                if (M(), n.src) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (P || (S = o.hiddenClass, P = x(S), S = "mfp-" + S), O = a.after(P).detach().removeClass(S)), t.updateStatus("ready")
            ...
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, a) {
                        ...
                        k("ParseAjax", r), t.appendContent(e(r.data), F), n.finished = !0, H(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(h)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function(n, i) {
                var o = 0,
                    a = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, k("ImageLoadComplete")) : (o++, 200 > o ? setTimeout(a, 100) : r()))
                    },
                    r = function() {
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, n && n.enabled ? (a += " mfp-gallery", I(p + o, function() {
    ...
    e.magnificPopup.registerModule(Y, {
        ...
        function() {
            ...
            e.fn.mfpFastClick = function(o) {
                return e(this).each(function() {
                    ...
                    if (n) {
                        ...
                        s.on("touchstart" + a, function(e) {
                            u = !1, f = 1, p = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], c = p.clientX, d = p.clientY, w.on("touchmove" + a, function(e) {
                                p = e.originalEvent ? e.originalEvent.touches : e.touches, f = p.length, p = p[0], (Math.abs(p.clientX - c) > 10 || Math.abs(p.clientY - d) > 10) && (u = !0, i())
                            }).on("touchend" + a, function(e) {
                                i(), u || f > 1 || (r = !0, e.preventDefault(), clearTimeout(l), l = setTimeout(function() {
                                    r = !1
                                }, t), o())
                            })
                        })
                ...
                e(this).off("touchstart" + a + " click" + a), n && w.off("touchmove" + a + " touchend" + a)
            }
        }(), E()
});